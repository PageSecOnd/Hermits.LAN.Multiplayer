...
namespace SlayTheSpire2.LAN.Multiplayer.Reforged.Components
{
    internal partial class IPAddressInfoPanel : Control
    {
        ...
        public static IPAddressInfoPanel Create()
        {
            ...
            AddAddressElement(container, "IPAddress", "SlayTheSpire2.LAN.Multiplayer.Reforged.IP_ADDRESS_TITLE", false);
            AddAddressElement(container, "IPV6IPAddress", "SlayTheSpire2.LAN.Multiplayer.Reforged.IPV6_ADDRESS_TITLE", true);
            AddAddressContainer(container, "LocalIPAddress", "SlayTheSpire2.LAN.Multiplayer.Reforged.LOCAL_IP_ADDRESS_TITLE");
